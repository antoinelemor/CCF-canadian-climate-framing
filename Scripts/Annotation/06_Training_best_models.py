...
5) Comprehensive logging  
   ...
   summaries to `Database/Training_data/Training_logs/…` and appends the final
...
def main():
    ...
    Main function to:
     ...
     6) Save logs to CSV in `Database/Training_data/Training_logs` and each final
    ...
    LOGS_DIR = os.path.join("Database", "Training_data", "Training_logs")
