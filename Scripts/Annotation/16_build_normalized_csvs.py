...
STATIC_CONFIG = {
    ...
    "reinforcement_trigger": "positive-class F1 < 0.70 at best normal epoch",
    "best_epoch_criterion": "0.98 * F1_class_1 + 0.02 * macro_F1 (combined)",
    "class_weighting_normal": "none (unweighted cross-entropy; pos_weight=None)",
    "class_weighting_reinforced": "WeightedRandomSampler (inverse-frequency oversampling) + class-weighted cross-entropy (weights [1.0, 3.5])",
