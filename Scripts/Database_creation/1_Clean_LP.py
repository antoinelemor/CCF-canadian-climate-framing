...
repertoire_ris = '/Volumes/CLIMATE.FRAME/Raw_data/La_Presse_ris'  # Modifier selon le répertoire réel
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/La_Presse_ris/clean_LP_data/clean_LP_data.csv'  # Chemin où sauvegarder le CSV
