...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/Star_Phoenix/clean_Star_Phoenix_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Star_Phoenix/clean_Star_Phoenix_data/articles_extraits.csv'
