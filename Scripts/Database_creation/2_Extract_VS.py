...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/Vancouver_Sun/clean_VS_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Vancouver_Sun/clean_VS_data/articles_extraits.csv'
