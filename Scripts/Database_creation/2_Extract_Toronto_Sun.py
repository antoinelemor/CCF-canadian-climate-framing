...
def traiter_article(lignes_article, donnees_articles):
    ...
    indice_fin = next((i for i, ligne in enumerate(lignes_article) 
                       if "copyright" in ligne.lower() or "sun media corporation" in ligne.lower()), None)
...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/Toronto_Sun/clean_Toronto_Sun_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Toronto_Sun/clean_Toronto_Sun_data/articles_extraits.csv'
