...
def traiter_article(lignes_article, donnees_articles):
    ...
    type_nouvelle = titre = auteur = 'Inconnu'
    ...
    numero_page = lignes_article[indice_fin - 2] if indice_fin and indice_fin > 1 else 'Inconnu'
...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/Montreal_Gazette/clean_Montreal_Gazette_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Montreal_Gazette/clean_Montreal_Gazette_data/articles_extraits.csv'
