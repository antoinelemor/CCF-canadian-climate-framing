...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/Edmonton_Journal/ED_clean_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Edmonton_Journal/ED_clean_data/articles_extraits.csv'
