...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/Toronto_Star/clean_TS_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Toronto_Star/clean_TS_data/articles_extraits.csv'
