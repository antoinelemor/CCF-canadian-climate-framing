...
repertoire_ris = '/Volumes/CLIMATE.FRAME/Raw_data/Journal_de_Montreal'  # Modifier selon le répertoire réel
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Journal_de_Montreal/clean_JDM_data/clean_JDM_data.csv'  # Chemin où sauvegarder le CSV
