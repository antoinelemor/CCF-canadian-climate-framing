...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/National_Post/clean_NP_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/National_Post/clean_NP_data/articles_extraits.csv'
