...
repertoire_ris = '/Volumes/CLIMATE.FRAME/Raw_data/Le_Droit'  # Modifier selon le répertoire réel
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Le_Droit/Le_Droit_clean_data/Clean_LeDroit.csv'  # Chemin où sauvegarder le CSV
