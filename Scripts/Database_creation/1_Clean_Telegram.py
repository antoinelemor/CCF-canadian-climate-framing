...
repertoire_ris = '/Volumes/CLIMATE.FRAME/Raw_data/Telegram'  # Modifier selon le répertoire réel
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Telegram/Telegram_clean_data/Clean_Telegram.csv'  # Chemin où sauvegarder le CSV
