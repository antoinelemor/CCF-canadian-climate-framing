...
repertoire_ris = '/Volumes/CLIMATE.FRAME/Raw_data/La_Presse_Plus'  # Modifier selon le répertoire réel
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/La_Presse_Plus/clean_LPP_data/clean_LPP_data.csv'  # Chemin où sauvegarder le CSV
