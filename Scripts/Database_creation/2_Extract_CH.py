...
chemin_fichier = '/Volumes/CLIMATE.FRAME/Raw_data/Calgary_Herald/clean_CH_data/combined_text.txt'
...
chemin_csv = '/Volumes/CLIMATE.FRAME/Raw_data/Calgary_Herald/clean_CH_data/articles_extraits.csv'
