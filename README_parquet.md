...
- **PostgreSQL edition** (canonical): [DOI `10.5281/zenodo.20667151`](https://doi.org/10.5281/zenodo.20667151) — ships `CCF_Database.tar` (37 GB, `pg_dump -Fd` archive with HNSW indexing).
- **Apache Parquet mirror** (this bundle): [DOI `10.5281/zenodo.20667154`](https://doi.org/10.5281/zenodo.20667154) — ships the six `.parquet` files described below.
